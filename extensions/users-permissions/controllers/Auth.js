...
module.exports = {
  ...
  async forgotPassword(ctx) {
    ...
    try {
      await strapi.plugins["email-manager"].services.email.sendEmailToUser(
        { email: user.email },
  ...
  async register(ctx) {
    ...
    params.username = await strapi.plugins[
      "utils"
    ].services.utils.getUniqueID();

    /*if (params.first_name) {
      // PJS - Reformat names for strapi
